        ...
        <div className="selections">
          ...
          <div className="selection">
            <div className="content">
              ...
              <div className="cards">
                <Image className={'card-img'} src={'/assets/img/mastercard-v2.svg'} width={40} height={25} />
                <Image className={'card-img'} src={'/assets/img/Netflix_2015_logo.svg'} width={40} height={25} />
          ...
          <div className="selection">
            <div onClick={handleClickBuy} className="content">
              ...
              <div className="cards">
                <Image className={'card-img'} src={'/assets/img/com-pay.svg'} width={40} height={25} />
              </div>
            </div>
            <ChevronRightIcon />
          </div>
